...
In addition to following the VGG16 architecture, the work used side-outputs, like several other existing approaches, described in Table \ref{table:cap4_artigos_selecionados}.
